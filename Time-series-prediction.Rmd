...
p <- ggplot(a, aes(x=med, y=sds)) + geom_point(size=0.8) + xlab('Mean') + ylab('Standard deviation') + ggtitle('Before Box-Cox Trasformation - Daily Aggrgation')
p
ggsave('plots/scatter.jpg', p, height = 3 , width = 5)

a <- data.frame(cbind(med_bc, sds_bc))
p <- ggplot(a, aes(x=med_bc, y=sds_bc)) + geom_point(size=0.8) + xlab('Mean') + ylab('Standard deviation') + ggtitle('After Box-Cox Trasformation - Daily Aggrgation')
p
